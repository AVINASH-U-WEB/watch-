...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  ...
  >
    ...
    {active!==id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[240px]">
        <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[240px] glassmorphisum mb-[16px]`}>
