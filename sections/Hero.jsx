    ...
    >
      <div className="flex justify-center items-center flex-col relative z-10">
        ...
        <motion.div variants={textVariant(1.2)} className="flex flex-row justify-center items-center">
          <h1 className={styles.heroHeading}>M</h1><img src="/watcho.png" alt="" className="w-[100px] h-[100px] object-contain" />
      ...
      className="relative w-full md:-mt-[20px] -mt-[12px]"
       ...
       <div className="absolute w-full h-[300px]    rounded-tl-[140px] z-[0] -top-[30px]" />
        <img src="/cover.png" className="w-full sm:h-[500px] h-[350px] object-cover rounded-tl-[140px] z-10 relative" alt="" />
        <a href="#explore">
